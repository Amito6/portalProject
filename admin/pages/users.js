const users = `
     <div class="users">
            ...
            <button data-bs-toggle="modal" data-bs-target="#users-modal" class="position-fixed bottom-0 right-0 m-16 btn bg-red-500 text-white w-11 h-11 rounded-full shadow-sm">
                <i class="fa fa-add"></i>
            </button>
                        ...
                        <div class="modal-body">
                            <form class="users-form">
                                ...
                                <div class="row mb-3">
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="fathers_name" id="father" required class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group">
                                ...
                                <div class="row mb-3">
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label for="father">Status<sup class="text-red-500">*</sup></label>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label for="userType">User Type <sup class="text-red-500">*</sup></label>
                                            <select class="form-select" name="usertype" id="usertype">
                                                <option value="selectusertype">Select-UserType</option>
                                                <option value="true">Admin</option>
                                                <option value="false">tecaher</option>
